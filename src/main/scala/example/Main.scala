...
object Main {
  ...
  Using the same setup as Challenge 4, convert an integer into a written string output, but in the fastest time possible!

  You can use all the submissions below to base your solution from, or feel free to rewrite, or come up with a brand new solution!

  I will try to get a good testing setup into this branch in the next couple of days.
